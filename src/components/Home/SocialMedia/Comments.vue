        ...
        >
          ...
          >
            ...
            <v-card-text
              ...
              v-html="getHyphenText(comment.data.text)"
            />
            <v-card
              class="absolute likes-comment px-2 right-0 rounded-xl"
              elevation="1"
              flat
            >
              <v-icon
          ...
          <div class="px-3 py-3">
            <v-row>
              ...
              <span class="cursor-hover timestamp underline">
                {{ new Date(comment.created_at).toString().substr(16, 5) }} -
                {{
                  new Date(comment.created_at).toString().substr(0, 10)
                }}</span>
              <v-spacer />
            </v-row>
          </div>
