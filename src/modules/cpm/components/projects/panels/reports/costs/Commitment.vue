    ...
    <v-form ref="form">
      <div class="col-sm-6 margin-top-15">
        <div class="card-container">
          ...
          <div class="form-group margin-top-25">
            ...
            <div v-if="showBudgetCategorySearch" class="budget-cat-select">
            ...
            >
              <v-expansion-panel-content
                ...
                :key="index"
              >
                <v-icon v-if="item.cat_1.length" slot="actions">
                  $vuetify.icons.expand
                </v-icon>
                <v-icon v-else slot="actions" color="white">
                  mdi-crop-free
                </v-icon>
                <v-card slot="header" class="pa-0" flat>
                  <v-card-title class="headline px-6 py-4 white">
                    ...
                    >
                      <v-icon color="green" light small>
                  ...
                  <v-card-text class="pa-0 vertical-scroll">
                    <v-expansion-panel class="elevation-0">
                      <v-expansion-panel-content
                        ...
                        :key="indexL2"
                      >
                        <v-icon v-if="itemL2.cat_2.length" slot="actions">
                          $vuetify.icons.expand
                        </v-icon>
                        <v-icon v-else slot="actions" color="white">
                          mdi-crop-free
                        </v-icon>
                        <v-card slot="header" class="pa-0 pl-4" flat>
                          <v-card-title class="headline px-6 py-4 white">
                            <span class="grey--text text--darken-1">
          ...
          <div class="form-group">
            <h5 class="mt-3">
              Attachments
              <v-btn class="mt-0" icon small @click.native.stop="selectFile">
              ...
              <template slot="append" slot-scope="{ item, open, leaf }">
                <template>
                  <template v-if="item.file">
                    <a :href="item.url" style="padding-top: 6px" target="_blank"
          ...
          <div class="form-group margin-top-25">
            ...
            >
              <v-row
                ...
                justify="center"
              >
                <v-progress-circular color="blue lighten-2" indeterminate />
              </v-row>
            </v-img>
        ...
        <div class="form-group">
          ...
          >
            <v-btn color="blue darken-3" outline @click.prevent="cancel">
              Cancel
            </v-btn>
            <v-btn
              color="blue darken-3"
      ...
      <div class="col-sm-6 margin-top-15">
        ...
        -->
          ...
          <div class="form-group margin-top-25">
            <label>Amount</label>
            <money v-model="lineItem.amount" v-bind="money" />
          </div>

          <div class="form-group margin-top-25">
            <label>Cost per item</label>

            <money v-model="lineItem.cost_per_item" v-bind="money" />
          </div>

          <div class="form-group margin-top-25">
            <label>Invoice total</label>
            <money v-model="lineItem.invoiceTotal" v-bind="money" />
          </div>
          ...
          <div class="form-group margin-top-25">
            ...
            <money v-model="lineItem.quantity_amount" v-bind="money" />
          </div>

          <div class="form-group margin-top-25">
            <label>Tax amount</label>
            <money v-model="lineItem.tax_amount" v-bind="money" />
          </div>

          <div class="form-group margin-top-25">
            <label>Total open amount with tax</label>
            <money v-model="lineItem.total_open_amount_w_tax" v-bind="money" />
          </div>

          <div class="form-group margin-top-25">
            <label>Total PO line amount</label>
            <money v-model="lineItem.total_po_line_amount" v-bind="money" />
          </div>
