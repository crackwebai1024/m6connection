  ...
  <div>
    <v-card flat>
      <v-card-title class="relative">
        <portal v-if="included" to="budget-0">
          <v-btn
            absolute
            class="mt-3"
            color="white"
    ...
    <v-dialog v-if="showForm" v-model="showForm" max-width="400px" persistent>
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form">
            ...
            />
            <input v-model="currentElement" type="hidden" />
            <div class="d-flex justify-end w-full">
              ...
              <v-btn class="ml-2" color="blue" dark type="submit" @click="save">
