<template>
  <component-template>
    <template slot="button">
      <v-btn color="primary" dark fab small @click="showForm = true">
    ...
    <v-card v-if="showForm" class="mt-2">
      <v-card-text class="vertical-scroll">
        <v-form ref="form">
          <h6 v-if="currentStatus" class="indigo--text">
            Editing:
          </h6>
          <v-text-field
            v-model="status"
          ...
          />
          <input v-model="currentStatus" type="hidden" />
          <v-btn color="blue" outline @click="cancel">
            Cancel
          </v-btn>
          <v-btn color="blue" dark type="submit" @click="saveStatus">
